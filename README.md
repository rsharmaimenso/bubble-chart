...
```
cd existing_repo
git remote add origin https://gitlab.com/mahesh321/bubble-chart.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mahesh321/bubble-chart/-/settings/integrations)
